...
//        String[] values = new String[] { "Annual income",
//                "Monthly rent",
//                "Monthly morguage",
//                "Monthly carloan payment",
//                "Monthly savings"
//        };
//
...
public class Profile extends Activity {
  ...
  //  private GoogleApiClient client;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.listProfile);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.textView1.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                   ...
                   // navigateUpTo(new Intent(this, ListDetailActivity.class));
                   // Profile.this.startActivity(new Intent(Profile.this, ListDetailActivity.class));
